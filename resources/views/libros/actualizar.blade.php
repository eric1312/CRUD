      ...
      <div class="modal-body">
        <form method="POST" action="{{ route('libros.update', $libro) }}">
          ...
          <div class="form-group">
            ...
            <input type="text" name="nombre" value="{{ $libro->nombre }}" class="form-control" required>
          </div>
          <div class="form-group">
            <label for="descripcion">Descripción:</label>
            <input type="text" name="descripcion" value="{{ $libro->descripcion }}" class="form-control" required>
          </div>
          <div class="form-group">
